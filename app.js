    ...
    cleanliness: [
      ...
      },
      {
        ...
        answers: [
          ...
          { label: "T'as passé les 1000, humain investi bientôt perdu.", delta: +1, image:"img/fabrice.png" },
          { label: "T'as passé les 2000, personne ténébreuse.",          delta: 0, image:"img/kazmoche.png" },
      ...
      },
      {
        ...
        answers: [
		  ...
		  { label: "Plus de 2 heures mais avec des pauses",                        delta: +2, image:"img/pause.gif" },
          { label: "2 heures sans pause",            delta: +1, image:"img/john.png" },
      ...
      },
      {
        ...
        answers: [
		  ...
		  { label: "Tu n'as pas oublié d'aérer c'est propre",                        delta: +2, image:"img/wind.gif" },
          { label: "Ça sent le meuble.",         delta: +1, image:"img/meuble.png" },
      ...
      },
      {
        ...
        answers: [
		  ...
		  { label: "T'as fait un effort sur ton style et ta skincare",                        delta: +2, image:"img/beau.gif" },
          { label: "T'es là quoi c'est tout.",               delta: +1, image:"img/pocket.png" },
          { label: "Les gens appliquent les gestes barrières avec toi.", delta:-2, image:"img/barrière.png" },
    ...
    playstyle: [
      {
        ...
        answers: [
          ...
          { label: "Full spam snake edge / hopkick / gimmicks.",               delta:-1, image:"img/xia.gif" },
          { label: "Setup macabre a base d'imblocable comme Chad-Muerte Prime.",  delta:-2, image:"img/patrick.png" },
        ],
      },
      {
        text: "Qu'en est-il de votre défense ?",
        answers: [
          { label: "De 80 à 100, le mur.",                                      delta:+4, image:"img/lmur.gif" },
          { label: "De 60 à 80, bloquer ne me dérange pas !",                   delta:+3, image:"img/placeholder.png" },
          { label: "De 40 à 60, se fait counter hit launch 3x par round...",    delta:+0, image:"img/luffy.png" },
      ...
      },
      {
        ...
        answers: [
		  ...
		  { label: "Tu launch et drop en faisant un combo troll, tu te fais remonter 3-2",               delta:-3, image:"img/fukug.gif" },
    ...
    rage: [
      ...
      },
      {
        ...
        answers: [
		  ...
		  { label: "C'est quoi ton problème, c'est quoi ton.. Qu'est-ce que je t'ai fait ?",                        delta: +2, image:"img/pblm.gif" },
          { label: "Je le ping et je lui envoi Gg ^^",                             delta: 0, image:"img/gg.png" },
          { label: "Petit recadrage textuel y'a pas le choix.",                    delta:-2, image:"img/type.png" },
    ...
    kindness: [
      ...
      },
      {
        ...
        answers: [
          ...
          { label: "T'acceptes un ft + quelques conseils.",         delta:+2, image:"img/coach.gif" },
          { label: "Désolé j'ai pas le temps fratello.",            delta:-2, image:"img/stop.png" },
      ...
      },
      {
        ...
        answers: [
          ...
          { label: "Tu veux vraiment continuer ?",                               delta: +2, image:"img/rock.gif" },
          { label: "Tu peux pas rester en négatif quand même.",                  delta:-2, image:"img/hypocrite.png" },
      ...
      },
      {
        ...
        answers: [
          ...
          { label: "Organisé un FT entre deux joueurs.",                       delta: +1, image:"img/orga.png" },
          ...
          { label: "Ramené un de tes amis sur le jeu",                        delta:-2, image:"img/pacte.png" },
        ],
      },
      {
      ...
      },
      {
        ...
        answers: [
          ...
          { label: "Trop faible pour toi il ne mérite pas le rematch",      delta:0, image:"img/lion.png" },
        ],
      },
    ],
    ...
    intellect: [
      {
        ...
        answers: [
          ...
          { label: "Regardes juste un ou deux combos sur YouTube.", delta: +2, image:"img/MJ.gif" },
      ...
      },
      {
        ...
        answers: [
          ...
          { label: "Safe on block",                              delta:-2, image:"img/damss.png" },
      ...
      },
      {
        ...
        answers: [
          ...
          { label: "Piff rage art",                                    delta:-2, image:"img/pifra.png" },
